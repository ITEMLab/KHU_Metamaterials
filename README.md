...
- **Baseline논문을 확인하고 싶으시면** → '논문들/[18]Inverse design of nonlinear mechanical metamaterials via video denoising diffusion models'
...
- 학습/추론용 데이터셋
    - Baseline 논문 데이터셋 다운로드 링크 :  https://doi.org/10.3929/ethz-b-000629716
    - 저희 논문 데이터셋 다운로드 링크 : https://drive.google.com/file/d/1912hUeNyHxh48ivE_ygzpz6cNOB_YsbS/view?usp=sharing
