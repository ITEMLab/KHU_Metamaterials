...
if material == 'Jin_et_al':
    ...
    m.materials[material_name].Hyperelastic(materialType=
        ISOTROPIC, table=((-32186.3329, 1.23058275, 0.0), 
                          (16200.1425, 1.30828010, 0.0), 
                          (15986.6668, 1.15023200, 0.0) ), 
        testData=OFF, type=OGDEN, n=3, 
...
if solver == 'explicit':
    ...
    if not y_periodicity:
        ...
        m.SurfaceToSurfaceContactExp(
            ...
            initialClearance=OMIT, interactionProperty='SlipContact', main =
            m.rootAssembly.instances['TopLine-1'].surfaces['TopSurf']
            , name='TopContact', secondary =
